...
export async function main(ns) {
  await ns.wget(
    "https://raw.githubusercontent.com/5p0ng3b0b/bitburner-scripts/main/autoinfiltrate.js",
    "exploits/infiltrate.js",
  );
  await ns.wget(
    "https://raw.githubusercontent.com/5p0ng3b0b/bitburner-scripts/main/devmenu.js",
    "exploits/devmenu.js",
  );
  await ns.wget(
    "https://raw.githubusercontent.com/alainbryden/bitburner-scripts/main/git-pull.js",
    "bin/git/alainbryden.js",
  );
...
export function rewriteFileForSubfolder(ns, path) {
  if (!options.subfolder || path.includes("skogixDownload.js")) return true;
