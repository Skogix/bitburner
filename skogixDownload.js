...
const argsSchema = [
    ...
    ['subfolder', 'skogix'], // Can be set to download to a sub-folder that is not part of the remote repository structure
...
export function rewriteFileForSubfolder(ns, path) {
    if (!options.subfolder || path.includes('skogixDownload.js'))
        return true;
